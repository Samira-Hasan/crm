              ...
              <div class="tab-pane" id="settings">
                <form class="form-horizontal" method="post" action="{{url('/profile') }}" enctype="multipart/form-data" >
                  ...
                  @if ($errors->any())
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputfName" placeholder="First Name" name="inputfName">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10" >
                      <input type="text" class="form-control" id="inputlName" placeholder="LastName" name="inputlName">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputPhone" placeholder="Phone" name="inputPhone">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea class="form-control" id="inputFacebook" placeholder="Facebook" name="inputFacebook"></textarea>
                    </div>
                  </div>
                  <div class="form-group">
